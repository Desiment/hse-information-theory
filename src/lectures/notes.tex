...
\include{chapters/chapter-01-info-theory/01-intro.tex}
\include{chapters/chapter-01-info-theory/02-entropy.tex}
\include{chapters/chapter-01-info-theory/03-mutual-information.tex}
\include{chapters/chapter-01-info-theory/04-entropy-of-random-variables.tex}
\include{chapters/chapter-01-info-theory/05-cross-entropy-kl-divergence.tex}

\chapter{Некоторые приложения}
\epigraph{Тот факт, что [данный] многочлен является приближением, необязательно уменьшает его полезность, поскольку все модели являются приближениями. В сущности, все модели неверны, но некоторые из них полезны.}{Джордж Бокс, британский статистик}

\localtableofcontents
\include{chapters/chapter-02-applications/01-trivial-applications.tex}
